...
Meteor.startup(function () {
  ...
  var img = HTTP.call('GET', 'http://www.gravatar.com/avatar/?d=mm&s=256');

  // console.log(img.content);
	// var base64      = new Buffer(img.content, 'binary').toString('base64');
