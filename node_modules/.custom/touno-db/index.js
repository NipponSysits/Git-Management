...
var name = config.arg == 'default' ? 'logs' : 'test';
var db = {
	CommitSince: mongoose.model(name+'_commits_sinces', SchemaCommitSince),
	Commits: mongoose.model(name+'_commits', SchemaCommits),
	Commits: mongoose.model(name+'_clients', SchemaClient),
}
